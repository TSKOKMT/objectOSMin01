...
void ofApp::keyPressed(int key){
    ...
    if (key == OF_KEY_RIGHT) myObjectOS.moduleIndex = ofWrap(myObjectOS.moduleIndex + 1, 0, 3);
    if (key == OF_KEY_LEFT) myObjectOS.moduleIndex = ofWrap(myObjectOS.moduleIndex - 1, 0, 3);
